                    ...
                    'parameters' => [
                        ...
                        ['name' => '$options[...]', 'description' => 'Plan\'s options...<br>
                            <ul>
                                ...
                                <li><span class="text-semibold">sending_server_option</span>: (' . Plan::SENDING_SERVER_OPTION_SYSTEM . '|' . Plan::SENDING_SERVER_OPTION_OWN . '|' . Plan::SENDING_SERVER_OPTION_SUBACCOUNT . ')</li>
...
-d price=20 \
-d color=red \
-d options[sending_server_option]=' . Plan::SENDING_SERVER_OPTION_OWN . ' \
